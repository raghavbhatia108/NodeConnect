            ...
            <div className={styles.profileCardsContainer}>
              {authState.all_profiles_fetched &&
                authState.all_users?.slice(0, 5).map((profile) => (
                  ...
                  >
                    <img
                      src={profile.userId?.profilePicture?.startsWith('http') ? profile.userId.profilePicture : `${BASE_URL}/uploads/${profile.userId?.profilePicture}`}
                      alt={profile.userId?.name}
                      className={styles.profileImage}
                    />
                    <div className={styles.profileInfo}>
                      <h4 className={styles.profileName}>{profile.userId?.name}</h4>
